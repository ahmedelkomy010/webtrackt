...
<body class="antialiased bg-slate-100 text-slate-800 min-h-screen">
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            <header class="bg-white border-b border-slate-200 px-4 lg:px-8 py-4 flex items-center justify-between lg:hidden">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2">
                    <img src="/images/logo.png" alt="Trakkt" class="h-8 w-8">
