...
<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
    @foreach ([
        ...
        ['label' => 'شركاؤنا في النجاح', 'value' => $stats['partners'], 'route' => 'admin.success-partners.index', 'color' => 'tract'],
        ['label' => 'أعمالنا', 'value' => $stats['works'], 'route' => 'admin.works.index', 'color' => 'indigo'],
        ['label' => 'أسئلة شائعة', 'value' => $stats['faqs'], 'route' => 'admin.faqs.index', 'color' => 'purple'],
